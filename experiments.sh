...
python train.py data/train.conll data/dev.conll --pretrained-embedding-file data/glove.6B.50d.txt --cache-processed-data --trainable-embeddings --experiment-name wo_emb_tune
